...
import type { Effect, Pipeline, ResolvedSettings, VctrfxSettings } from './types.ts'

const DEFAULT_PREFIX = 'vctrfx'
...
export const resolveSettings = (settings: VctrfxSettings = {}): ResolvedSettings => ({
