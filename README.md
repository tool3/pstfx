...
Every example runs twice: on still artwork, and on [`tetrahedron.svg`](https://github.com/tool3/vctrfx/blob/master/examples/sources/tetrahedron.svg) —
